        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-8">
            ...
            <div className={`rounded-xl shadow-lg p-5 sm:p-6 transition-all duration-300 hover:scale-[1.02] ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
                <div className="flex items-center justify-between gap-3">
                    ...
                    <div className={`flex-shrink-0 p-2 sm:p-4 rounded-full ${darkMode ? 'bg-green-900/30' : 'bg-green-100'}`}>
            ...
            <div className={`rounded-xl shadow-lg p-5 sm:p-6 transition-all duration-300 hover:scale-[1.02] ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
                <div className="flex items-center justify-between gap-3">
                    ...
                    <div className={`flex-shrink-0 p-2 sm:p-4 rounded-full ${darkMode ? 'bg-red-900/30' : 'bg-red-100'}`}>
            ...
            <div className={`rounded-xl shadow-lg p-5 sm:p-6 transition-all duration-300 hover:scale-[1.02] ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
                <div className="flex items-center justify-between gap-3">
                    ...
                    <div className={`flex-shrink-0 p-2 sm:p-4 rounded-full ${darkMode ? 'bg-blue-900/30' : 'bg-blue-100'}`}>
