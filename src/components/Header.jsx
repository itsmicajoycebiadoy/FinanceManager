  ...
  return (
    <>
      ...
      <header className="bg-gradient-to-r from-black to-amber-600 shadow-xl sticky top-0 z-50">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            {/* PINALITAN: Title and Icon Container - Sinisigurong laging inline at centered */}
            ...
            <div className="flex items-center gap-2 sm:hidden">
              ...
              >
                ...
                {deletedTransactions.length > 0 && (
                  <span className="absolute top-0 right-0 w-4 h-4 bg-red-500 rounded-full flex items-center justify-center border border-white animate-pulse">
      ...
      <div className={`fixed inset-0 z-50 transform ${mobileMenuOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 ease-in-out`}>
        ...
        {/* Sidebar Menu - Positioned at right-0 */}
        <div className="absolute right-0 top-0 h-full w-64 bg-gradient-to-b from-black to-amber-900 shadow-2xl">
          {/* Close Button */}
          ...
          {/* Sidebar Title - Pantay rin dapat dito */}
          <div className="flex items-center gap-3 px-6 pb-6 border-b border-amber-700">
            <svg className="w-8 h-8 text-amber-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path>
            </svg>
            <h2 className="text-xl font-bold text-white whitespace-nowrap">Finance Manager</h2>
          </div>
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-amber-700 bg-black/30">
            ...
            <p className="text-xs text-gray-400 mt-1">Created by: Mica Joyce Bialoy</p>
          </div>
        </div>
      </div>
    </>
